...
$\begin{pmatrix} x_1 & x_2 \end{pmatrix}$ 
   $\begin{pmatrix} 1 & 3 \\ 3 & 2 \end{pmatrix}$ $\begin{pmatrix} x_1 \\ x_2 \end{pmatrix}$ = $\bold{x^{2}_1 + 6x_1x_2 + 2x^{2}_2}$ \ 
                                  ->$\text{\textit{(quadratic form in 2 variables)}}$\
  ...
  -In 1-dimensional case: $x*a*x = ax^2$ & $\frac{d}{dx}(xax)=2ax$\
